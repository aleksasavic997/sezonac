...
class Header extends StatefulWidget {
  ...
  const Header(this._height, this._showIcon, this._icon, {Key key}) : super(key: key);

  @override
  _HeadertState createState() => _HeadertState(_height, _showIcon, _icon);
}
...
class _HeadertState extends State<Header> {
  ...
  _HeadertState(this._height, this._showIcon, this._icon);
